<%@ Page Title="Editar Mascota" Language="C#" MasterPageFile="~/Site.Master" 
    AutoEventWireup="true" CodeBehind="ModificarMascota.aspx.cs" 
    Inherits="tpcuatrimestral.Vistas.ModificarMascota" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4" style="max-width: 500px;">
        ...
        <div class="d-flex justify-content-between">
            ...
            <br />
            <br />
<asp:Label ID="lblCartel" runat="server" Font-Size="X-Large" ForeColor="Red"></asp:Label>
