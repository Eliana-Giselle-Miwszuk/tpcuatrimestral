<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Veterinarios.aspx.cs" Inherits="tpcuatrimestral.Vistas.Veterinarios.Veterinarios" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <asp:LinkButton ID="lkbAgregar" runat="server" Class="btn btn-primary" PostBackUrl="~/Vistas/AgregarVeterinarios.aspx" Height="30px" Width="131px">Agregar</asp:LinkButton>
    </p>
    <asp:TextBox ID="txtNombre" runat="server" placeholder="Ingrese Nombre" Height="38px" Width="179px"></asp:TextBox>
    <asp:Button ID="btnBuscarNombre" runat="server" Class="btn btn-success" Height="43px" Text="Aplicar" Width="84px" />
    <p>
    </p>
    <p>
    </p>
    ...
    DataKeyNames="IDVeterinario" AllowPaging="true" PageSize="10">
    <Columns>
